...
public final class NetworkUtils {
     ...
     * 检查当前网络是否连接
     *
     * @param context 如果当前网络没有连接在activity中弹出提示框进行网络设置。
     * @return false:	没有连接网络
     */
    public static boolean checkNetworkState(Context context) {
        /** 判断有没有网 **/
        try {
            return TYPE_NULL != getcheckNetworkState(context);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
     ...
     * 获取当前网络类型
     */
    public static int getcheckNetworkState(Context context) {
        int netWorkState = TYPE_NULL;
