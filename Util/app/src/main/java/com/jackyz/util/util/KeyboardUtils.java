...
/**
 * 关于EditText禁止默认吊用软键盘:在父级添加这两句话  android:focusable="true"-->android:focusableInTouchMode="true"
 * 设置一开始进来不弹出软键盘并且软键盘弹出后不会重新绘制activity里面的view : android:windowSoftInputMode="stateHidden|stateUnchanged"
